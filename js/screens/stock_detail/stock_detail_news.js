	 ...
	 //==========
		render() {
              ...
              <Content>
                ...
                {/* List */}
                <View style={[common_styles.margin_5]}><Text style={[common_styles.heading_1]}>NEWS DOCUMENTS</Text></View>
                <View><Text style={[common_styles.font_15, common_styles.darkGrayColor, common_styles.margin_5]}>Tap title to download</Text></View>
