      ...
      SNAPSHOT: { //general info
		...
		STOCK_DETAIL: {
			QUOTE: {
				...
				TRADE_DATA: setting.BACKEND_SERVER + 'stock/trade/data/<symbol>?symbol=<symbol>&page=1&pageSize=20',
				SHORT_INTEREST: setting.BACKEND_SERVER + 'stock/short-sale/<symbol>?symbol=<symbol>&page=1&pageSize=20'
			}
		}
